<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyer.aspx.cs"  %>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="PurchaseDeptAddInfo.aspx" class="nav-link">
          ...
          <div class="card1">
            ...
            <form id="form1" runat="server">
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="sr_no" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="50%">
                ...
                <Columns>
                    <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" id="cf" />
                    <asp:BoundField DataField="sr_no" HeaderText="sr_no" InsertVisible="False" ReadOnly="True" SortExpression="sr_no" />
                    <asp:BoundField DataField="purchase_date" HeaderText="purchase_date" SortExpression="purchase_date" DataFormatString="{0:d}" />
                    ...
                    <ItemTemplate>
                    <%#  Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "purchase_date")).AddDays((Int32)(Eval("days"))).ToShortDateString() %>
                    </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source = (localdb)\ProjectsV13; Initial Catalog = data; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False" DeleteCommand="DELETE FROM [Purchases] WHERE [sr_no] = @sr_no" InsertCommand="INSERT INTO [Purchases] ([purchase_date], [weight], [price], [discount], [days], [angadiya], [broker_name], [brokerage], [party_name], [payment_status]) VALUES (@purchase_date, @weight, @price, @discount, @days, @angadiya, @broker_name, @brokerage, @party_name, @payment_status)" SelectCommand="SELECT * FROM [Purchases]" UpdateCommand="UPDATE [Purchases] SET [purchase_date] = @purchase_date, [weight] = @weight, [price] = @price, [discount] = @discount, [days] = @days, [angadiya] = @angadiya, [broker_name] = @broker_name, [brokerage] = @brokerage, [party_name] = @party_name, [payment_status] = @payment_status WHERE [sr_no] = @sr_no">
                <DeleteParameters>
            ...
            <!-- /.card-body -->
                 <asp:Button ID="add" runat="server" Text="Add" OnClientClick="Add_click" ></asp:Button>
              </form>
          </div>
          <!-- /.card -->
